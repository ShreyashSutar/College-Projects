<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Airpods.aspx.cs" Inherits="Airpods" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" BorderColor="#FF9933" Height="120px" 
        BackColor="#FF9933" style="background-color: #000000" Width="1408px">
        ...
        <img alt="" class="newStyle13" src="Accessories%20Images/Logo.jpeg" style="top: 6px; left: 7px; width: 198px; height: 124px; margin-bottom: 9px;" />
    </asp:Panel>
     <p>
         &nbsp;</p>
    <p>
        <img alt="" class="newStyle7" 
            src="Accessories%20Images/Air%20pods/1.jpg" 
            style="top: 181px; left: 100px; width: 281px; height: 227px" /></p>
    <p>
        <img alt="" class="newStyle8" 
            src="Accessories%20Images/Air%20pods/2.jpg" /></p>
    <p>
        <img alt="" class="newStyle9" src="Accessories%20Images/Air%20pods/3.jpg" 
    ...
    <p>
        <asp:Label ID="Label2" runat="server" CssClass="newStyle10" 
            Text="Boat Airpods 281"></asp:Label>
    </p>
    <asp:Label ID="Label3" runat="server" CssClass="newStyle11" 
        ...
        Text="AirPods 3"></asp:Label>
    <asp:Label ID="Label4" runat="server" CssClass="newStyle12" 
        Text="pTron bassbuds jets"></asp:Label>
    <p>
        <img alt="" class="newStyle14" 
            src="Accessories%20Images/Air%20pods/4.jpg" 
    ...
    <img alt="" class="newStyle16" 
        src="Accessories%20Images/Air%20pods/5.jpg" 
