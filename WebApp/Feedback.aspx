...
<body style="background-color: black;">
    ...
    <form id="form1" runat="server">
            ...
            <asp:Label ID="Label1" runat="server"  CssClass="newStyle14 style5" 
                style="left: 656px; top: 75px; color:White;" Text=""><h1 style="padding-left: 19%;">Feedback Form!!!</h1><br /></asp:Label><br />
+
        <div>
...
<asp:Button ID="Button1" CssClass="button" style="width: 60vh; height: 50px;" runat="server" Text="SUBMIT" 
