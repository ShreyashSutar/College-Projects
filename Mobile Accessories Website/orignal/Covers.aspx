<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Covers.aspx.cs" Inherits="Covers" %>
...
<body>
    <form id="form1" runat="server">
     <asp:Panel ID="Panel1" runat="server" BorderColor="#FF9933" Height="120px" 
        ...
        <img alt="" class="newStyle13" src="Accessories%20Images/Logo.jpeg" style="top: 7px; left: 7px; width: 208px; height: 130px; margin-right: 3px;" />
    </asp:Panel>
     <p>
         &nbsp;</p>
    <p>
        <img alt="" class="newStyle7" 
            src="Accessories%20Images/Covers/1.jpg" 
            style="top: 181px; left: 100px; width: 281px; height: 227px" /></p>
    <p>
        <img alt="" class="newStyle8" 
            src="Accessories%20Images/Covers/2.jpg" /></p>
    <p>
        <img alt="" class="newStyle9" src="Accessories%20Images/Covers/3.jpg" 
    ...
    <asp:Label ID="Label3" runat="server" CssClass="newStyle11" 
        style="top: 416px; left: 480px; height: 39px; width: 289px; text-align: center; font-size: large; font-family: 'Copperplate Gothic Bold'; font-weight: 700; color: #666666; right: 517px;" 
        Text="OnePlus 9R"></asp:Label>
    <asp:Label ID="Label4" runat="server" CssClass="newStyle12" 
        Text="Iphone 13"></asp:Label>
    <p>
        <img alt="" class="newStyle14" 
            src="Accessories%20Images/Covers/4.jpeg" 
    ...
    <p>
        <asp:Label ID="Label5" runat="server" CssClass="newStyle15" 
            Text="Asus Rog Phone 5"></asp:Label>
    </p>
    <img alt="" class="newStyle16" 
        src="Accessories%20Images/Covers/5.jpeg" 
    ...
    <p style="height: 335px; width: 1266px">
        <asp:Label ID="Label6" runat="server" CssClass="newStyle17" 
            Text="Redme Note 10 pro"></asp:Label>
    &nbsp;&nbsp;
    </p>
    </form>
</body>
